  ...
  return (
    ...
    >
      <button
        ...
        className="aria-checked:bg-primary-main group mt-1 flex h-5 w-[40px] overflow-hidden rounded-xl bg-slate-400 p-1 outline-none transition-colors duration-200 ease-in-out focus-visible:ring focus-visible:ring-blue-400"
      >

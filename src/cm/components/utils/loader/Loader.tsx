'use client'
import {CenterScreen, C_Stack} from 'src/cm/components/styles/common-components/common-components'
...
export default function Loader(props: any) {
  ...
  return (
    <>
      <div className={`fixed inset-0 bg-white/50 `} style={{zIndex: Z_INDEX.loader}}>

          ...
          {registerdItems.map((item, index) => {
            ...
            return (
              <tr key={index}>
                ...
                <td>
                  <div>{DH.toPrice(retailPrice)}</div>
                  <div>{DH.toPrice(wholesalePrice)}</div>
                  <div>{minimum || 0}</div>
                </td>
                <td>
                  <div>
                  ...
                  <div>
                    =<strong className={` text-sm text-red-500`}>{DH.toPrice(wholesalePrice * quantity)}</strong>
                  </div>
                </td>
              </tr>
            )

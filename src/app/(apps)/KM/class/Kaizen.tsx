import {createGradient} from '@cm/lib/methods/common'
  ...
  tagBadge: ({color = 'cool', children}) => {
    ...
    return (
      <IconBtn
        ...
        style={{
          fontWeight: 'bold',
          background: tailProps.colors?.kaizen?.[color]?.light,
          color: tailProps.colors.kaizen?.[color]?.main,
          border: `1px solid ${tailProps.colors.kaizen?.[color]?.main}`,

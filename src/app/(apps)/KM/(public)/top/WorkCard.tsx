...
export const WorkCard = ({work}) => {
  ...
  return (
    <div style={{width: cardWidth}} className={`bg-white`}>
      <div
        className={`shadow-kaizen-cool-main ring-kaizen-cool-main  hover:bg-kaizen-cool-light/50 rounded-t-lg shadow-lg  hover:ring-2  `}
      >
        <TextAccordion minHeight={480} maxHeight={550}>
          <div
            style={{background: Kaizen.const.gradient.coolMain}}
            className={` bg-kaizen-cool-main          rounded-t-lg  p-2 `}
          >
        ...
        <div style={{background: Kaizen.const.gradient.coolMain, color: 'white'}} className={`p-2   `}>
          <R_Stack>
            <Tags {...{work}} />
    ...
    <C_Stack className={`gap-4`}>
      {description && (
        <section className={`text-[15px] leading-5`}>
          <div
            ...
            className={cl(sectionClassName, `text-kaizen-cool-main bg-kaizen-cool-light`)}
          >
            <C_Stack className={`gap-4`}>
              <div>
      ...
      {impression && (
        <section>
          <div
            style={{
              background: Kaizen.const.gradient.warmLight,
            }}
            className={cl(sectionClassName, `bg-kaizen-warm-light/50`)}
          >
            <C_Stack>

...
import useFileUploadProps from '@cm/hooks/useFileUpload/useFileUploadProps'
...
const ReadTable = ({csvContents}) => {
  return (
    <div className={` sticky-table-wrapper max-h-[300px] ${CssString.table.borderCerlls} w-[300px]`}>
      <table>
        <thead>
          <tr>
            <th>ID</th>

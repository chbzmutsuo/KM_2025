...
export default function TaskScoring({game}) {
  ...
  const classroomMaster = Arr.uniqArray(
            ...
            <div>
              <C_Stack className={`gap-3`}>
                <C_Stack className={`items-stretch justify-between`}>
                  ...
                  <Arrow />
                  <section>
                    <ColoredText className="mb-4 text-center text-3xl font-bold" bgColor={tailProps.colors.primary.main}>
                  ...
                  <Paper className={`  w-[800px]`}>
                    ...
                    <table className={CssString.table.borderCerlls}>
                      <tbody></tbody>
                    </table>
                  </Paper>
                </C_Stack>

...
export default async function Page(props) {
  ...
  const prismaExtractionQuery: prismaDataExtractionQueryType = {
    ...flexQuery,
    where: {AND: [...flexQuery.AND], secretKey},
    include: !include ? undefined : {...include},
  }

  const prismaData = await searchModels(dataModelName, prismaExtractionQuery)
  ...
  return <GameMainPage {...{game, secretKey, prismaExtractionQuery}} />
}

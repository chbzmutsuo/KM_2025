...
export default function SalesNewCC() {
  ...
  const {latestFormData, Form: CustomerSelector} = useCustomerSelector({cartUser, setcartUser, maxWidth})
  ...
  const onSubmit = async () => {
    toggleLoad(async () => {
      ...
      // const customerDetailPage = HREF(`/aquapot/aqCustomer/${aqCustomerId}`, {}, query)
      // router.push(customerDetailPage)
      // settabIndex({aqCustomerDetailPage: 4})
